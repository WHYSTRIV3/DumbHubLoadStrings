...
local SelectedCharaterTable = {"Luffe", "Saajy", "White Beard"}
--Variables
local SelectedFighters;
local SelectedAreas;
...
Main:CreateToggle("Auto Wins", true, function()
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(16380.8086, 27672.0703, 8057.86182, -8.10623169e-05, 8.10623169e-05, -1, -1, 8.10623169e-05, 8.10623169e-05, 8.10623169e-05, 1, 8.10623169e-05)
end)
