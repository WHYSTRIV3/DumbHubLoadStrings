...
local ui = library:CreateWindow("Clicker Party Simulator!")
...
function getPortals()
    ...
    for _,v in pairs(WS.Portals:GetChildren()) do
...
Main:CreateToggle("Click", true, function()
    game:GetService("ReplicatedStorage").Click:FireServer("e")
end)
...
Main:CreateToggle("Auto Rebirth", true, function()
    ...
    RS.Rebirth:FireServer(SelectedRebirth, "a")
    end
end)


--[[ Main:CreateToggle("Auto Up", true, function()
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer( "Speed")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("XP")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("MaxLevel")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("InstantGolden")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("PetEquip")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Luck")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Inventory")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("AutoClick")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Buttons")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Jump")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Speed")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Gems")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Clicks")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Buttons")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Buttons")
    game:GetService("ReplicatedStorage").GetUpgradeCost:InvokeServer("Buttons")
...
Teleport:CreateDropdown("Portals", getPortals(), function(Portals)
...
Teleport:CreateButton("Teleport", function()
    if SelectedPortals then
        local TeleportCFrame = WS.Portals[SelectedPortals].To.Detector.CFrame
...
local ohString3 = "asdgouhsaiugdhasoiudghodsagfasdgdsaoughsadoug"

game:GetService("ReplicatedStorage").HatchEvents.Hatch:FireServer(ohString1, ohString2, ohString3)
    end
end)
