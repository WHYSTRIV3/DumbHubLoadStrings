...
function getraceMaps()
    ...
    for _,v in pairs(WS.raceMaps:GetChildren()) do
        table.insert(raceMaps, v.Name)
    end
    return raceMaps
end
...
Main:CreateToggle("Auto Collect Orbs/Gems", true, function()
    for i, v in pairs(WS.orbFolder:GetDescendants()) do
...
Main:CreateToggle("Auto Hoops", true, function()
...
Main:CreateToggle("Auto Join Race", true, function()
...
Egg:CreateToggle("Auto Crystal", true, function()
...
for _,v in pairs(Player.petsFolder:GetDescendants()) do
    RS.rEvents.petEvolveEvent:FireServer("evolvePet", v.Name)
    end
end)
