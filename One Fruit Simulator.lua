...
local ui = library:CreateWindow("One Fruit Simulator")
...
Main:CreateToggle("Auto Streangth", true, function()
local ohTable1 = {
	[1] = {
		[1] = utf8.char(3),
		[2] = "Combat",
...
Main:CreateToggle("Auto Defence", true, function()
local ohTable1 = {
	[1] = {
		[1] = utf8.char(3),
		[2] = "Defence",
		[3] =  Player.Character.Defence,
		[4] = "Defence"
	}
}
...
Main:CreateToggle("Auto Ground Smash ", true, function()
local ohTable1 = {
	[1] = {
		[1] = utf8.char(3),
		[2] = "skillsControl",
		...
		[4] = "Z",
		[5] = "Release",
		[6] = Player.Character.HumanoidRootPart.CFrame
	}
}
