...
local ui = library:CreateWindow("Tapping Simulator!")
...
Main:CreateToggle("Auto Halloween Click", true, function()
        Wait(0.1)
    local ohNumber1 = 5
...
Teleport:CreateButton("Teleport To Spawn", function()
        local TeleportCFrame = WS.Zones.Spawn.CFrame
